        ...
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 lg:gap-16 max-w-6xl bg-white rounded-lg shadow-lg p-6">
          ...
          <div className="space-y-6">
            ...
            <button>
              <Link
                href="/ShopList"
                className="flex items-center text-center justify-center m-auto bg-[#FF9F0D] text-black px-4 py-2 hover:bg-orange-400 w-full sm:w-auto"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  ...
                  viewBox="0 0 24 24"
                >
                  <path d="M10 19a1 1 0 0 1-.71-.29l-7-7a1 1 0 0 1 0-1.42l7-7a1 1 0 1 1 1.42 1.42L4.41 11H21a1 1 0 0 1 0 2H4.41l6.3 6.29a1 1 0 0 1-1.42 1.42l-7-7A1 1 0 0 1 3 10l7 7A1 1 0 0 1 10 19Z" />
                </svg>
                Back To Shop
              </Link>
            </button>
